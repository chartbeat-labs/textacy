...
class VSMTestCase(unittest.TestCase):
    ...
    def test_vectorizer_feature_names(self):
        self.assertIsInstance(self.vectorizer.feature_names, list)
        self.assertIsInstance(self.vectorizer.feature_names[0], unicode_)
        self.assertEqual(
            len(self.vectorizer.feature_names),
            len(self.vectorizer.vocabulary))
    ...
    def test_get_term_freqs_normalized(self):
        ...
        self.assertEqual(len(term_freqs), self.doc_term_matrix.shape[1])
        self.assertAlmostEqual(term_freqs.max(), 0.15625, places=4)
        self.assertAlmostEqual(term_freqs.min(), 0.03125, places=4)
        self.assertAlmostEqual(term_freqs[self.idx_lamb], 0.15625, places=4)
        self.assertAlmostEqual(term_freqs[self.idx_child], 0.06250, places=4)
    ...
    def test_get_information_content(self):
        ...
        self.assertAlmostEqual(ics.max(), 1.0, places=4)
