...
def test_sgrank_ngrams_1_2_3(spacy_doc):
    ...
    observed = [term for term, _ in keyterms.sgrank(spacy_doc, ngrams=(1, 2, 3), n_keyterms=5)]
    assert len(expected) == len(observed)
    # can't do this owing to randomness of results
    # for e, o in zip(expected, observed):
    #     asert e == o
...
def test_textrank(spacy_doc):
    ...
    observed = [
        term for term, _ in keyterms.textrank(spacy_doc)]
    assert len(expected) == len(observed)
    # can't do this owing to randomness of results
    # for e, o in zip(expected, observed):
    #     asert e == o
...
def test_textrank_norm_none(spacy_doc):
    ...
    observed = [
        term for term, _
        in keyterms.textrank(spacy_doc, normalize=None, n_keyterms=5)]
    assert len(expected) == len(observed)
    # can't do this owing to randomness of results
    # for e, o in zip(expected, observed):
    #     asert e == o
...
def test_singlegrank_norm_none(spacy_doc):
    ...
    observed = [
        term for term, _
        in keyterms.singlerank(spacy_doc, normalize=None, n_keyterms=5)]
    assert len(expected) == len(observed)
    # can't do this owing to randomness of results
    # for e, o in zip(expected, observed):
    #     asert e == o
